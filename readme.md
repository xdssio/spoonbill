...
| Operation                    | InMemoryDict | BucketDict                 | RedisDict                                  | LmdbDict                                            | PysosDict                                   | DynamoDBDict                                     | FireStoreDict                                               | CosmosDB                                                                                               | MongoDbDict                             |
|------------------------------|--------------|----------------------------|--------------------------------------------|-----------------------------------------------------|---------------------------------------------|--------------------------------------------------|-------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|-----------------------------------------|
...
| set_batch                    | √            | √                          | √                                          | √                                                   | √                                           | √                                                | √                                                           | √                                                                                                      | √                                       |
| persistence                  | X            | √                          | √                                          | √                                                   | √                                           | √                                                | √                                                           | √                                                                                                      | √                                       |
| save/load                    | √            | X                          | X                                          | X                                                   | X                                           | X                                                | X                                                           | X                                                                                                      | X                                       |
| key type (Not strict/strict) | Any          | Any(local) / String(cloud) | Any/String                                 | Any                                                 | Any                                         | String                                           | Any/String                                                  | String                                                                                                 | String                                  |
| value_type                   | Any          | Any(local) / String(cloud) | Any/String                                 | Any                                                 | Any                                         | Jsonable                                         | Any                                                         | Any                                                                                                    | Any                                     |
